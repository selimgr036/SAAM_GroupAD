...
Apply all five, and the eligible universe starts at 813 firms in 2013 and grows to over 1,150 by the early 2020s. The main driver of that growth is filter F4, the carbon disclosure requirement. As sustainability reporting became more widespread, more firms entered our eligible set each year.
...
The second portfolio, and the most practically important one, is the VW50. This is a tracking-error-minimising portfolio subject to a 50% carbon footprint reduction. Annual return falls from 11.45% to 10.73% — a difference of 72 basis points. One caveat here: the VW benchmark rebalances monthly, while the VW50 forms annually. That rebalancing frequency change contributes to the performance gap alongside the carbon constraint, so 72 basis points is an upper bound on the carbon cost alone. In exchange, the carbon footprint halves from 116.2 to 57.7, and the WACI nearly halves from 168.0 to 85.5. For investors with ESG mandates or carbon-reporting requirements, this difference is a limited and defensible cost even at its upper bound.
...
Second, minimum variance is not a carbon strategy. The MVP in our universe ended up with a higher carbon footprint than the VW benchmark, both in CF and WACI terms. If carbon reduction is an objective, you need an explicit constraint. The VW50 is the clean solution here. One practical note though: the VW50's worst monthly return over the sample was -15.05%, versus -13.20% for the VW benchmark. Annual formation means you cannot rebalance going into a crash, so in sharp drawdown months the VW50 can underperform the benchmark more severely.
